...
// To take avantage of the NSCopying protocol, I have to change the Appointment class so that is is derived from NSOnject, which defines the copy method.
...
var beerMeeting = Appointment(name: "Bob",
                              day: "Mon",
